    ...
    <>
      ...
      <section className="relative min-h-[600px] rounded-3xl overflow-hidden mb-12 flex">
        ...
        <div className="relative z-20 flex flex-col justify-center p-16 max-sm:p-8 w-full md:w-1/2">
          <h1 className="text-5xl font-bold text-white mb-6 max-w-xl text-on-spline">
            Get Interview-Ready with AI-Powered Practice & Feedback
          </h1>
          <p className="text-xl text-white/90 mb-8 max-w-lg text-on-spline">
        ...
        <div className="absolute right-0 top-0 bottom-0 w-full md:relative md:w-1/2 h-full">
          <SplineBackground
      ...
      <div className="flex justify-center content-center mt-6 items-center">
        <div className="gap-x-1">
          <div className="sm:text-5xl text-2xl text-[#CCCEEF] text-center">
            Where everyone
            ...
            <div className="gap-2 pl-5 pr-5">
              <p className="sm:text-2xl text-[16px] text-center mt-3 justify-center items-center">
      ...
      <div className="flex flex-col items-center">
        <section className="max-w-4xl px-4 text-center mt-[-50]">
          <div className="sm:text-4xl text-2xl mt-7 from-[#466CCF] text-transparent bg-clip-text bg-gradient-to-r to-[#FF3BD4] font-bold text-center leading-[1.2]">
            WHY CHOOSE US
          </div>
